...
Leopardus_wiedii_random <- generate_occ_uncertain(Leopardus_wiedii, lat_col = "latitude", lon_col = "longitude", lat_uncertainty = "lat_uncertainty", lon_uncertainty = "lon_uncertainty", taxa_col = "species")
...
# 6. Using the random occurences in land metrics
...
```{r}
random_range(Leopardus_wiedii, lat_col = "latitude", lon_col = "longitude", 
