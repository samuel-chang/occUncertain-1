...
```
uncertainty_meters_to_decdeg_naZero <-
  meters_to_decdeg(
    occs_df,
    lat_col = "latitude",
    lon_col = "longitude",
...
```
uncertainty_meters_to_decdeg_naNA <-
  meters_to_decdeg(
    occs_df,
    lat_col = "latitude",
    lon_col = "longitude",
...
```
uncertainty_meters_to_decdeg_naMean <-
  meters_to_decdeg(
    occs_df,
    lat_col = "latitude",
    lon_col = "longitude",
...
For this example, the funtion uses 10 loops to randomize latitudes and longitudes occurrences, using mean unceetainty for NA values previously obtained with *meters_to_decdeg*.  
```
